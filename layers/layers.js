...
jsonSource_RendimientodePanelaTonHa_2.addFeatures(features_RendimientodePanelaTonHa_2);var lyr_RendimientodePanelaTonHa_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/RendimientodePanelaTonHa_2_0.png" />  0,5 - 2,5 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_1.png" />  2,5 - 4,6 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_2.png" />  4,6 - 7,5 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_3.png" />  7,5 - 9,9 <br />\
    <img src="styles/legend/RendimientodePanelaTonHa_2_4.png" />  9,9 - 13,9 <br />'
        });
...
lyr_RendimientodePanelaTonHa_2.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO_1': 'CULTIVO_1', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', });
...
lyr_RendimientodePanelaTonHa_2.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO_1': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', });
...
lyr_RendimientodePanelaTonHa_2.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO_1': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', });
